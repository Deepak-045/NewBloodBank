...
$approvedRequestsQuery = "SELECT COUNT(*) AS approved_requests FROM requests WHERE status = 'approved'"; 
$approvedRequestsResult = $conn->query($approvedRequestsQuery);
$approvedRequestsData = $approvedRequestsResult->fetch_assoc();
$approvedRequests = $approvedRequestsData['approved_requests'];
